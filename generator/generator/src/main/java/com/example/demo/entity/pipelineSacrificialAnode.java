...
public class pipelineSacrificialAnode {
    ...
    private BigDecimal psaSacrificialCurrentout;

    private BigDecimal psaSacrificialAnodeGroundingPotential;

    private BigDecimal psaSacrificialAnodeGroundingResistance;
    ...
    public BigDecimal getPsaSacrificialCurrentout() {
        return psaSacrificialCurrentout;
    }

    public void setPsaSacrificialCurrentout(BigDecimal psaSacrificialCurrentout) {
    ...
    public BigDecimal getPsaSacrificialAnodeGroundingResistance() {
        return psaSacrificialAnodeGroundingResistance;
    }

    public void setPsaSacrificialAnodeGroundingResistance(BigDecimal psaSacrificialAnodeGroundingResistance) {
